...
function makeItemByTemplate(testItem) {
    const { title, description, img, tags, price } = testItem;
    const myItem = itemTemplate.content.cloneNode(true);
...
items.forEach((item) => {
    container.append(makeItemByTemplate(item));
})